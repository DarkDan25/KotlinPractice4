 ...
 * Use the [SavedFiles.newInstance] factory method to
 * create an instance of this fragment.
 */
class SavedFiles : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val folder = view.context.filesDir
        ...
        inputStream.close()
        val recyclerView: RecyclerView? = this.activity?.findViewById(R.id.saved_files)
